...
class EagleDraftModel(DraftModel):
    """
    This is the base class for the Eagle draft model implementation.
    """
    drafter_model_type = "LlamaForCausalLMEagle"

    @torch.no_grad()
    def load_lm_head(self, model_path: str, lm_head_key: str = "lm_head.weight"):
        lm_head = load_checkpoint(model_path, lm_head_key)
